...
<!DOCTYPE html>
    ...
    <body>
        ...
        <form action="index_login.php" method="POST" class="formulario">
        <?php
            ...
            <section class="container_full">
                    ...
                    <section class="datos">
                        ...
                        <section class="datos_contraseña">
                            ...
                            <input type="text" name="pass" class="respuesta_contraseña" placeholder="Ingresa la contraseña">
                    ...
                    <section class="enviar">
                        ...
                        <a class="forgot" href="index_forgot.html">Olvidaste tu contraseña?</a>
